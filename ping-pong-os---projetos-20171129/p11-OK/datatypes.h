...
#define ADORMECIDA 'a'//Tarefa adormecida
...
typedef struct task_t
{
    ...
    int executions;
    int exitCode;
    struct task_t *suspensas; //lista de tarefas que foram suspenas por ela
    int wakeTime; // tick em que a tarefa deve ser acordada
} task_t ;
